...
int get_bin(int length) {
    int bins[] = {10, 100, 1000, 2500, 5000, 10000, 20000, 30000, 40000, 50000, 75000, 100000, 200000, 300000, 500000, 600000, 700000, 800000, 900000, 1000000, 1500000, 2500000, 5000000};
